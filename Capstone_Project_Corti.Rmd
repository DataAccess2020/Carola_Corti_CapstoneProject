...
# Text analyses of the Financial Express articles about smart cities

## Scraping the articles from the Financial Express web page

***The Financial Express*** is an Indian English -language business newspaper owned by The Indian Express Group, which has been published since 1961. The newspaper specializes in Indian and international business and financial ...

The articles were imported in R following a series of web scraping operations using the R packages Rvest, Httr and Stringr, in order to download textual information to build a corpus by using the Quanteda package and, eventually, analyze it performing text analytics. The aim, here, is to download the whole articles' texts from pages 1 to 5 from the Financial Express website's smart cities- dedicated session.
